...
> ## Challenge 4
> Install the palmerpenguins and here packages, and copy the "penguins.csv" to your data folder.
>
> 1. Install the package with: `install.packages(c("palmerpenguins", "here"))`
> 2. Find the location of the "penguins.csv" with `palmerpenguins::path_to_file("penguins.csv")`
> 3. Copy the file to your data folder
> ```r
> penguin_path <- palmerpenguins::path_to_file("penguins.csv")
> file.copy(penguin_path, here::here("data", "penguins.csv"))
> ```
{: .challenge}
